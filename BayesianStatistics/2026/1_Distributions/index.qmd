...
## On Normal Distributions {.center background-color="#1A237E"}
...
## On Binomial Distributions {.center background-color="#1A237E"}
...
## On Uniform Distributions {.center background-color="#1A237E"}
...
## On Beta Distributions {.center background-color="#1A237E"}
...
## On Gamma Distributions {.center background-color="#1A237E"}
...
## On Cauchy Distributions {.center background-color="#1A237E"}
...
## On *t*-Distributions {.center background-color="#1A237E"}
...
df <- data.frame(
  var1 = rnorm(10000, mean = 0, sd = 1),
  var2 = runif(10000, min = -5, max = 5)
)
...
- What is the distribution of `var1` alone? 
- What is the distribution of `var2` alone?
