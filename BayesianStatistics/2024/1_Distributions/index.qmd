...
TODO
- Introduce the idea of sequences (1:10) to iterate on, concept of iterations
- Introduce the idea of initalization of empty objects and sequential combination
