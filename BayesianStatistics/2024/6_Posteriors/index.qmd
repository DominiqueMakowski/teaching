...
- How it can be used to compare models using Bayes Factors (BF)
- That we can set priors over parameters of interest (e.g., correlation coefficients) using distributions
- This theory has wide applications beyond statistics (e.g., in neuroscience)
...
- prior distribution over parameters are the starting point
...
- However, we can still draw random samples from this distribution
- By drawing many samples, we get an empirical approximation of the posterior distribution
- This process of random sampling is called **Markov Chain Monte Carlo (MCMC)**
...
<!-- TODO: MCMC: https://www.youtube.com/watch?v=rZk2FqX2XnY&t=788s&ab_channel=RichardMcElreath -->
