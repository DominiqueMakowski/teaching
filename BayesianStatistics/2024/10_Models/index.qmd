...
- Paradoxically, Bayes Factors are complicated to obtain to compare Bayesian models
  - Not impossible, but typically computationally expensive
  - Not recommended given that good alternatives exist
...
- Provides a robust measure of model's predictive accuracy (without direct complexity adjustment)
